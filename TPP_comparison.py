...
for i, decoy in zip(w, decoy_list):
    ...
    pAla.calulate_decoy_FLR(i + "/" + sub + "/" + "All_confident_PTM_no_collapse_Site-based_spectrum_match_FLR.csv",
                            decoy)
    pAla.calulate_decoy_FLR(
        i + "/" + sub + "/" + "All_confident_PTM_no_collapse_Site-based_spectrum_match_new_FLR_collapse.csv", decoy)
    pAla.calulate_decoy_FLR(
        i + "/" + sub + "/" + "All_confident_PTM_no_collapse_Site-based_spectrum_match_FLR_filtered.csv", decoy)
    pAla.calulate_decoy_FLR(
        i + "/" + sub + "/" + "All_confident_PTM_no_collapse_Site-based_spectrum_match_FLR_PTM_sort.csv", decoy)
    final_file_list.append(
        i + "/" + sub + "/" + "All_confident_PTM_no_collapse_Site-based_spectrum_match_FLR_" + decoy + ".csv")
    final_file_list_collapsed.append(
        i + "/" + sub + "/" + "All_confident_PTM_no_collapse_Site-based_spectrum_match_new_FLR_collapse_" + decoy + ".csv")
    final_file_list_filtered.append(
        i + "/" + sub + "/" + "All_confident_PTM_no_collapse_Site-based_spectrum_match_FLR_filtered_" + decoy + ".csv")
    final_file_list_PTM.append(
        i + "/" + sub + "/" + "All_confident_PTM_no_collapse_Site-based_spectrum_match_FLR_PTM_sort_" + decoy + ".csv")
...
for i, decoy in zip(w, decoy_list):
    ...
    final_file_list_collapse.append(
        i + "/" + sub + "/" + "Site_confident_PTM_unique_new_FLR_collapse_" + decoy + ".csv")
Post_analysis.plot_FLR_comparisons(sub, final_file_list, s, p)
